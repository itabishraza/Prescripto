...
const Login = () => {
    ...
    return (
        <form onSubmit={onSubmitHandler} className='min-h-[80vh] flex items-center '>
            <div className='flex flex-col gap-3 m-auto items-start p-8 min-w-[340px] sm:min-w-96 border rounded-xl text-[#5E55E] text-sm shadow-lg'>
                ...
                <button type='submit' className='bg-primary text-white w-full rounded-md p-2 m-1 text-base'>Login</button>
