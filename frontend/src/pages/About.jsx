    ...
    return (
        <div>
            ...
            <div className='flex flex-col md:flex-row mb-20 mt-5'>
                <div className='border px-10 md:px-16 py-8 md:py-16 flex flex-col text-[15px] gap-4 hover:bg-primary hover:text-white transition-all duration-300 cursor-pointer'>
                    <b>Efficiency:</b>
